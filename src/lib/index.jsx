...
export const nyanWithProps = withProps((props) => ({
  keyMap: {
    escModifier: 'esc',
    nyan: 'command+alt+shift+ctrl+k'
  },
  keyHandlers: {
...
export const NyanRender = ({keyHandlers, shouldShowNyan, ...props }) => (
  <HotKeys keyMap={props.keyMap} handlers={props.keyHandlers} attach={window} >
